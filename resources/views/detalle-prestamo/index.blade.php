    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                {{ __('Detalle Prestamos') }}
                            </span>

                             <div class="float-right">
                                <a href="{{ route('detalle-prestamos.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Create New') }}
                                </a>
                              </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('detalle-prestamos.destroy', $detallePrestamo->id) }}" method="POST">
                                                    ...
                                                    <a class="btn btn-sm btn-success" href="{{ route('detalle-prestamos.edit', $detallePrestamo->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
                ...
                {!! $detallePrestamos->withQueryString()->links() !!}
            </div>
        </div>
    </div>
@endsection
