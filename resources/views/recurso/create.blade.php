...
@section('title', isset($recurso) ? 'Editar Recurso' : 'Agregar Recurso')
  ...
  <div class="card shadow-sm">
    <div class="card-body">
      <h5 class="card-title fw-bold mb-1">
        {{ isset($recurso) ? 'Editar Recurso' : 'Agregar Nuevo Recurso' }}
      </h5>
      <p class="text-muted small mb-4">
        Complete los campos para registrar un nuevo recurso o editar uno existente.
      </p>

      <form id="recursoForm" class="row g-3"
            method="POST"
