...
/*(function () {
  ...
  <button id="btnTour" class="btn-tour" style="display: none;">
    <strong>?</strong>
  </button>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // Variable para almacenar el objeto driver si la ruta coincide
      let driverObj = null;

  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      if (path.includes('/dashboard'))
      {
        btnTour.style.display = "block"; // Mostrar botón solo si la ruta coincide
        driverObj = driver({
            opacity: 0.75,
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      // Inicia el tour al hacer click solo si se ha definido para esta ruta
      if (driverObj) {
      ...
      // Si la ruta no coincide, el botón permanece oculto debido al 'style="display: none;"' en el HTML.
    });  
