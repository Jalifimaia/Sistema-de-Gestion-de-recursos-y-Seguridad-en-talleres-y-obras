  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-danger text-white">
        <h5 class="modal-title" id="modalErrorPrestamosLabel">Error</h5>
      ...
      <div class="modal-body">
        <div class="d-flex align-items-start gap-3">
          <div>
            <p class="mb-2">
              <strong id="modalErrorNombreRecurso"></strong>
              <span id="modalErrorCategoriaSubcategoria" class="text-muted small d-block mt-1"></span>
            </p>
            <p class="mb-0">
              Este recurso tiene series con préstamos registrados. No se puede dar de baja mientras existan préstamos activos asociados.
            </p>
          </div>
        </div>
      </div>
